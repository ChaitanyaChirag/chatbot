          ...
          lang => (
            <div className={`ori-absolute ori-animated ori-animation-half ori-bg-black-light ori-align-full ori-z-index-99995 ori-pad-20 ori-flex-column ori-flex-center ${isMounted ? "ori-fade-in" : "ori-fade-out"}`}>
              ...
              <div className="ori-flex-row ori-flex-jc ori-t-pad-15">
                ...
                <Button
                  className={`ori-lr-mrgn-10 ori-lr-pad-20 ${is_internet_connected ? "ori-btn-fill-primary" : ""}`}
                  size="small"
                  disabled={!is_internet_connected}
                  onClick={onClickSend}
                >
                  {is_internet_connected ? translator.text[lang].send : translator.text[lang].connecting}
                </Button>
              </div>
            </div>
          )
